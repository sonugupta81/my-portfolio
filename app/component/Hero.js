      ...
      <div className="md:w-2/3 flex flex-col gap-6">
        <div className="flex flex-col md:flex-row gap-6">
          <div className=" md:w-2/3 flex flex-col gap-6 bg-rose-100 rounded-xl p-10">
            ...
            <p className="md:w-4/6 text-5xl font-bold w-full pt-15">
        ...
        <div className="w-full flex flex-col md:flex-row gap-6  ">
          <div className="md:w-1/2 bg-rose-100 rounded-xl pt-10">
            <div className=" px-12 pb-15">
              <Image className="" src={picture} alt="Portfolio" height={50} width={50} />
            </div>
          ...
          <div className="md:w-1/2 bg-rose-300 rounded-xl pt-10 pb-10">
      ...
      <div className="md:w-1/3 flex flex-col rounded-xl">
        <div className="  ">
          <div className="bg-rose-100 p-8 rounded-xl">
            ...
            <div>
              <p className="text-3xl border-t-3 border-rose-300 pt-8 pb-8">
                {" "}
                Elara
              </p>
              <p className="text-3xl border-t-3 border-rose-300 pt-8 pb-8">
          ...
          <div className="flex gap-15 justify-center   bg-rose-100 rounded-xl mt-8 py-17">
